...
function Platform() {
	...
	if (score >= 5000) this.types = [1, 2, 4, 3, 4, 3, 4, 4];
	else if (score >= 2000 && score < 5000) this.types = [1, 3, 2, 3, 4, 2, 4, 3, 4, 1, 4];
	else if (score >= 1000 && score < 2000) this.types = [1, 2, 3, 4, 2, 3, 1, 3];
	else if (score >= 500 && score < 1000) this.types = [1, 1, 1, 1, 1, 3, 2, 2, 2, 2, 1, 3, 1];
